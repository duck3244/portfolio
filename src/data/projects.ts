...
export const projects: Project[] = [
  {
    id: 'project-1',
    title: '자사 AI 솔루션 고도화 및 LLM·RAG 기반 응용 서비스 개발',
    description: 'AI Agent 기반 데이터 수집 및 분석 자동화 솔루션 개발 및 고도화',
    period: '2026.01 - 2026.04',
    role: 'AI Engineer',
    company: '넥스트코드',
    tasks: [
      'AI Agent 기반 데이터 수집 기능 설계 및 개발',
      '3 Tier DB(PostgreSQL, Milvus, Neo4j) 설계 및 개발',
      'Open LLM Fine-Tuning(GPT-OSS, Gemma4), Agent, Chatbot 기능 설계 및 개발',
    ],
    technologies: [
      'Python',
      'JavaScript',
    ...
    achievements: [
      '자사 AI 솔루션(Agent/Chatbot) 기능 고도화',
      '고객 맞춤형 LLM·RAG 기반 응용 서비스 개발',
      'AI 모델 최적화 및 서비스 품질 향상',
    ],
  },
  {
    id: 'project-2',
    title: 'SKHy AI Enabled 비정형 데이터 시스템 구축',
    description: 'SK Hynix Cloud 기반 플랫폼 개발',
    period: '2025.06 - 2025.12',
    role: 'AI Engineer',
    company: '시프트원',
    tasks: ['LLM 서비스 API 및 백엔드 플랫폼 개발', '서버 장비 관리 플랫폼 설계 및 개발'],
    technologies: ['Java', 'Spring Boot', 'Windows', 'Oracle', 'Redis', 'Bitbucket'],
    achievements: ['LLM 서비스 플랫폼 개발 완료', '서버 장비 관리 플랫폼 개발 완료'],
  },
  {
    id: 'project-3',
  ...
  },
  {
    ...
    technologies: ['Python', 'Pytorch', 'Transformers', 'FAISS', 'Streamlit', 'CUDA', 'Ubuntu'],
    achievements: ['건설업 관련 법률 챗봇 프로토타입 개발', '투자 유치에 기여'],
  },
  {
    id: 'project-5',
  ...
  },
  {
    ...
    achievements: ['건설현장 영상 기반 안전관리 프로토타입 개발'],
  },
  {
    id: 'project-7',
    ...
    technologies: ['Python', 'Matlab', 'Scikit-learn', 'Numpy', 'App Designer', 'Windows'],
    achievements: ['국내외 기술 홍보 및 공동 연구 개발 진행'],
  },
  {
    id: 'project-8',
    title: '자동차 휠 베어링 고장 예측 알고리즘 연구',
    description:
      '(충북지역 주력산업 육성사업 과제) 자동차 휠 베어링 고장 예측 알고리즘 연구 및 시스템 구축',
    ...
    technologies: ['Python', 'Numpy', 'Windows', 'MongoDB'],
    achievements: ['국책 과제 수행 및 기초 연구 완료'],
  },
  {
    id: 'project-9',
    title: '자동차 휠 베어링 고장 검출 알고리즘 연구',
    description:
      '(충북지역 주력산업 육성사업 과제) 자동차 휠 베어링 고장 검출 알고리즘 연구 및 시스템 개발',
    ...
    technologies: ['Python', 'Tensorflow', 'Scikit-learn', 'Numpy', 'Windows'],
    achievements: ['국책 과제 수행 및 신규 과제 수주'],
  },
  {
    id: 'project-10',
    ...
    achievements: ['주요 고객사와 협약으로 인해 시범 사업 추진'],
  },
  {
    id: 'project-11',
    title: '지능형 빅데이터 해석학 기술을 이용한 선로전환기 고장예측진단 시스템',
    description:
      '(중소기업기술혁신개발 [과제번호:S2312692]) 선로전환기의 고장 진단 및 수명을 예측하기 위해 산학협력을 통한 연구 개발',
    ...
    achievements: ['프로젝트 가능성 타당성 검증 후 기술 내재화 프로젝트로 승격'],
  },
  {
    id: 'project-12',
    title: '3D공간정보 구축기반 감시정찰용 자동이착륙 무인이동체 시스템',
    description:
      '(특구기술사업화사업 [과제번호:14DD1093]) 자동이착륙과 미리 설정한 경로를 기반으로 비행하는 드론을 개발',
    ...
    achievements: ['국책 과제 수행 및 초기 모델 개발 완료'],
  },
];
